...
def configure(conf):
    ...
    conf.check_cfg(package='json-glib-1.0', uselib_store='JASON',
            atleast_version='0.14', mandatory=True, args='--cflags --libs')
    conf.check_cfg(package='sdl', uselib_store='SDL',
            atleast_version='1.2', mandatory=True, args='--cflags --libs')  
    conf.check_cfg(package='SDL_image', uselib_store='SDL-IMAGE',
            atleast_version='1.2', mandatory=True, args='--cflags --libs')
